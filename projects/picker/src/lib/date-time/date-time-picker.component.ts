    ...
    implements OnInit, OnDestroy
{
    ...
    public open(): void {
        ...
        this.hidePickerStreamSub =
            this.pickerContainer.hidePickerStream.subscribe(() => {
                this.close();
            });

        // Listen to picker container's confirmSelectedStream
        this.confirmSelectedStreamSub =
            this.pickerContainer.confirmSelectedStream.subscribe(
                (event: any) => {
    ...
    private openAsPopup(): void {
        ...
        if (!this.popupRef.hasAttached()) {
            ...
            this.pickerBeforeOpenedStreamSub =
                this.pickerContainer.beforePickerOpenedStream
                    .pipe(take(1))
                    .subscribe(() => {
                        this.beforePickerOpen.emit(null);
                    });
